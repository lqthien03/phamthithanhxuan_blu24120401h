...
$sanphamList = $d->rawQuery("select id, name$lang,desc$lang,content$lang,photo,icon, slugvi, slugen  from #_product_list where type = ? and find_in_set('noibat',status) and find_in_set('hienthi',status)", array('san-pham'));
