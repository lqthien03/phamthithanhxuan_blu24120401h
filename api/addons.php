...
if ($type == 'video-fotorama') {
    ...
    if (count($video_home)) { ?>
        <div id="fotorama-videos" data-width="100%" data-thumbmargin="10" data-height="260" data-fit="cover" data-thumbwidth="200" data-thumbheight="120" data-allowfullscreen="true" data-nav="thumbs">
