...
!function(e) {
    ...
    var t = function(t) {
        return this.each(function() {
            var n, i, a = e(this), c = a.data(), r = [a], o = this.tagName, l = 0;
            n = e.extend({
                content: "body",
                headings: "h1,h2,h3"
            }, {
            ...
            i = n.headings.split(","),
            e(n.content).find(n.headings).attr("id", function(t, n) {
                return n || function(e) {
                    0 === e.length && (e = "?");
                    for (var t = changeToSlug(e), n = "", i = 1; null !== document.getElementById(t + n); )
                        n = "_" + i++;
                    return t + n
                }(e(this).text())
            }).each(function() {
                ...
                if (n > l) {
                    ...
                    r.splice(0, Math.min(l - n, Math.max(r.length - 1, 0)));
                e("<li/>").appendTo(r[0]).append(e("<a/>").text(t.text()).attr("data-rel", "#" + t.attr("id"))),
                l = n
            })
        })
    }
