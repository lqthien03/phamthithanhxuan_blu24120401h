    ...
    <div class="sidebar">
        <nav class="mt-3">
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent text-sm" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <?php
                $active = "";
                if ($com == 'chatai1') $active = 'active';
                ?>
                <li class="nav-item <?= $active ?> <?= $none ?> ">
                    <a class="nav-link <?= $active ?> chatail" href="https://poe.com/Gemini-1.0-Pro" target="_blank" title="Chat với AI">
                        <img src="assets/images/iconai.gif" alt="" class="chatai">
                        <p>Chat với AI</p>
                    </a>
                </li>
