    ...
    <form class="validation-form" novalidate method="post" action="<?= $linkSave ?>" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-xl-4">
                ...
                <?php } ?>
                <?php if (isset($config['product'][$type]['icon_cat']) && $config['product'][$type]['icon_cat'] == true) { ?>
                    <div class="card card-primary card-outline text-sm">
                        <div class="card-header">
                            <h3 class="card-title">Icon <?= $config['product'][$type]['title_main_cat'] ?></h3>
                            <div class="card-tools">
                        ...
                        <div class="card-body">
                            ...
                            $photoDetail1['dimension'] = "Width: " . $config['product'][$type]['width_icon_cat'] . " px - Height: " . $config['product'][$type]['height_icon_cat'] . " px (" . $config['product'][$type]['img_type_cat'] . ")";
                            /* Image */
